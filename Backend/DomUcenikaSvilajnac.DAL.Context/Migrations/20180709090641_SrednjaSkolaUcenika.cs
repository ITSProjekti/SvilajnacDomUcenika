    ...
    public partial class SrednjaSkolaUcenika : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("insert into SrednjeSkole (NazivSrednjeSkole, OpstinaId) values " +
               ...
               "('Ekonomsko – ugostiteljska škola - \"Slobodan Minic\"', (select Id from Opstine where NazivOpstine = 'Arandelovac'))," +
               "('Ekonomsko ugostiteljska škola \"Slobodan Minic\"', (select Id from Opstine where NazivOpstine = 'Arandelovac'))," +
               "('Gimnazija \"Miloš Savkovic\"', (select Id from Opstine where NazivOpstine = 'Arandelovac'))," +
               "('Tehnicka škola \"Mileta Nikolic\"', (select Id from Opstine where NazivOpstine = 'Arandelovac'))," +
               ...
               "('Poljoprivredna škola - Bac', (select Id from Opstine where NazivOpstine = 'Bac'))," +
               "('Srednja strucna škola \"Dr Radivoj Uvalic\"', (select Id from Opstine where NazivOpstine = 'Backa Palanka'))," +
               "('Gimnazija \"20. oktobar\"', (select Id from Opstine where NazivOpstine = 'Backa Palanka'))," +
               "('Tehnicka škola \"9. maj\"', (select Id from Opstine where NazivOpstine = 'Backa Palanka'))," +
               "('Srednja tehnicka škola \"Šinkovic Jožef\"', (select Id from Opstine where NazivOpstine = 'Backa Topola'))," +
               "('Poljoprivredna škola - Backa Topola', (select Id from Opstine where NazivOpstine = 'Backa Topola'))," +
               "('Gimnazija i ekonomska škola \"Dositej Obradovic\"', (select Id from Opstine where NazivOpstine = 'Backa Topola'))," +
               "('Gimnazija \"Jan Kolar\"', (select Id from Opstine where NazivOpstine = 'Backi Petrovac'))," +
               ...
               "('Srednja škola \"Nikola Tesla\"', (select Id from Opstine where NazivOpstine = 'Batocina'))," +
               "('Tehnicka škola - Becej', (select Id from Opstine where NazivOpstine = 'Becej'))," +
               "('Gimnazija - Becej', (select Id from Opstine where NazivOpstine = 'Becej'))," +
               "('Ekonomsko - trgovinska škola - Becej', (select Id from Opstine where NazivOpstine = 'Becej'))," +
               "('Škola za osnovno i srednje obrazovanje \"Bratstvo\"', (select Id from Opstine where NazivOpstine = 'Becej'))," +
               ...
               "('XIII beogradska gimnazija', (select Id from Opstine where NazivOpstine = 'Cukarica'))," +
               "('Hemijsko-prehrambena tehnološka škola', (select Id from Opstine where NazivOpstine = 'Cukarica'))," +
               "('Tehnicka škola (Železnik)', (select Id from Opstine where NazivOpstine = 'Cukarica'))," +
               "('Muzicka škola \"Vatroslav Lisinski\"', (select Id from Opstine where NazivOpstine = 'Cukarica'))," +
               "('Škola za osnovno i srednje obrazovanje \"Sveti Sava\"', (select Id from Opstine where NazivOpstine = 'Cukarica'))," +
               ...
               "('III beogradska gimnazija', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               "('XIV beogradska gimnazija', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               "('Muzicka škola \"Josif Marinkovic\"', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               "('Tehnicka škola GSP', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               "('Muzicka škola \"Stankovic\"', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               "('Muzicka škola \"Josip Slavenski\"', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               "('Arhitektonska tehnicka škola - Vracar', (select Id from Opstine where NazivOpstine = 'Vracar'))," +
               ...
               "('Macvanska srednja škola', (select Id from Opstine where NazivOpstine = 'Bogatic'))," +
               ...
               "('Mašinsko-saobracajna škola - Cacak', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Škola za osnovno i srednje obrazovanje \"1. oktobar\"', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Muzicka škola \"Dr Vojislav Vuckovic\"', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Tehnicka škola - Cacak', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Prehrambeno - ugostiteljska škola - Cacak', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Medicinska škola - Cacak', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Ekonomska škola - Cacak', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Gimnazija - Cacak', (select Id from Opstine where NazivOpstine = 'Cacak'))," +
               "('Ugostiteljsko - turisticka škola - Cajetina', (select Id from Opstine where NazivOpstine = 'Cajetina'))," +
               "('Hemijsko - prehrambena srednja škola - Coka', (select Id from Opstine where NazivOpstine = 'Coka'))," +
               "('Ekonomsko - trgovinska škola Kruševac', (select Id from Opstine where NazivOpstine = 'Cicevac'))," +
               "('Škola za muzicke talente - Cuprija', (select Id from Opstine where NazivOpstine = 'Cuprija'))," +
               "('Medicinska škola \"Danilo Dimitrijevic\"', (select Id from Opstine where NazivOpstine = 'Cuprija'))," +
               "('Tehnicka škola - Cuprija', (select Id from Opstine where NazivOpstine = 'Cuprija'))," +
               "('Gimnazija - Cuprija', (select Id from Opstine where NazivOpstine = 'Cuprija'))," +
               ...
               "('Ekonomsko - trgovinska škola - Dragas', (select Id from Opstine where NazivOpstine = 'Dragas'))," +
               "('Ekonomska škola - Gorazdevac', (select Id from Opstine where NazivOpstine = 'Gorazdevac'))," +
               "('Gimnazija - Gorazdevac', (select Id from Opstine where NazivOpstine = 'Gorazdevac'))," +
               "('Tehnicka škola \"Dragi Popovic\"', (select Id from Opstine where NazivOpstine = 'Gornje Kusce'))," +
               ...
               "('PTehnicka škola \"Mihajlo Pupin\" - Indija', (select Id from Opstine where NazivOpstine = 'Indija'))," +
               "('Gimnazija - Indija', (select Id from Opstine where NazivOpstine = 'Indija'))," +
               "('Srednja škola \"Dr Ðorde Natoševic\"', (select Id from Opstine where NazivOpstine = 'Indija'))," +
               ...
               "('Srednja škola - Knic', (select Id from Opstine where NazivOpstine = 'Knic'))," +
               ...
               "('Tehnicka škola - Kosjeric', (select Id from Opstine where NazivOpstine = 'Kosjeric'))," +
               ...
               "('Gimnazija \"Mihajlo Pupin\" - Kovacica', (select Id from Opstine where NazivOpstine = 'Kovacica'))," +
               ...
               "('Ekonomsko-trgovinska i mašinska škola - Kucevo', (select Id from Opstine where NazivOpstine = 'Kucevo'))," +
               ...
               "('Srednja škola \"Nikola Tesla\" - Leposavic', (select Id from Opstine where NazivOpstine = 'Leposavic'))," +
               ...
               "('Srednja škola – Zvecan', (select id from Opstine where NazivOpstine = 'Zvecan'))," +
               ...
               "('Škola za osnovno i srednje obrazovanje \"Jelena Majstorovic\" Zajecar', (select id from Opstine where NazivOpstine = 'Zajecar'))," +
               "('Medicinska škola - Zajecar', (select id from Opstine where NazivOpstine = 'Zajecar'))," +
               "('Ekonomsko-trgovinska škola - Zajecar', (select id from Opstine where NazivOpstine = 'Zajecar'))," +
               "('Tehnicka škola - Zajecar', (select id from Opstine where NazivOpstine = 'Zajecar'))," +
               "('Gimnazija - Zajecar', (select id from Opstine where NazivOpstine = 'Zajecar'))," +
               ...
               "('Ugostiteljsko-turisticka škola sa domom ucenika - Vrnjacka Banja', (select id from Opstine where NazivOpstine = 'Vrnjacka Banja'))," +
               "('Gimnazija - Vrnjacka Banja', (select id from Opstine where NazivOpstine = 'Vrnjacka Banja'))," +
               ...
               "('Srednja škola \"Vuk Karadžic\" - Secanj', (select id from Opstine where NazivOpstine = 'Secanj'))," +
               ...
               "('Srednja škola \"Ðura Jakšic\" - Raca', (select id from Opstine where NazivOpstine = 'Raca'))," +
               ...
               "('Srednja škola \"Mladost\" - Petrovac', (select id from Opstine where NazivOpstine = 'Backi Petrovac'))," +
               "('Tehnicka škola \"Milenko Verkic Neša\" - Pecinci', (select id from Opstine where NazivOpstine = 'Pecinci'))," +
               "('Tehnološka škola - Paracin', (select id from Opstine where NazivOpstine = 'Paracin'))," +
               "('Ekonomsko-trgovinska škola - Paracin', (select id from Opstine where NazivOpstine = 'Paracin'))," +
               "('Mašinsko-elektrotehnicka škola - Paracin', (select id from Opstine where NazivOpstine = 'Paracin'))," +
               "('Gimnazija - Paracin', (select id from Opstine where NazivOpstine = 'Paracin'))," +
               "('Mašinska škola \"Pancevo\"', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Poljoprivredna škola \"Josif Pancic\"', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Medicinska škola \"Stevica Jovanovic\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Tehnicka škola \"23. maj\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Gimnazija \"Uroš Predic\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Elektrotehnicka škola \"Nikola Tesla\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Ekonomsko-trgovinska škola \"Paja Marganovic\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Muzicka škola \"Jovan Bandur\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Baletska škola \"Dimitrije Parlic\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Škola za osnovno i srednje obrazovanje \"Mara Mandic\" - Pancevo', (select id from Opstine where NazivOpstine = 'Pancevo '))," +
               "('Ekonomska škola \"Valjevo\" - Osecina', (select id from Opstine where NazivOpstine = 'Osecina'))," +
               ...
               "('Gimnazija - Novi Pazar', (select id from Opstine where NazivOpstine = 'Novi Pazar'))," + //-as
               ...
               "('Srednja škola - Novi Becej', (select id from Opstine where NazivOpstine = 'Novi Becej'))," +
