    ...
    public partial class SrednjaSkolaUcenika : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("insert into SrednjeSkole (NazivSrednjeSkole, OpstinaId) values " +
               ...
               "(N'Tehnička škola \"Milentije Popovic\" - Crna Trava', (select Id from Opstine where NazivOpstine = N'Crna Trava'))," +
               "(N'Mašinsko-saobraćajna škola - Čačak', (select Id from Opstine where NazivOpstine = N'Čačak'))," +
               "(N'Škola za osnovno i srednje obrazovanje \"1. oktobar\" - Čačak', (select Id from Opstine where NazivOpstine = N'Čačak'))," +
               "(N'Muzička škola \"Dr Vojislav Vuckovic\" - Čačak', (select Id from Opstine where NazivOpstine = N'Čačak'))," +
               ...
               "(N'Tehnička škola \"Jovan Žujovic\" - Gornji Milanovac', (select Id from Opstine where NazivOpstine = N'Gornji Milanovac'))," +
               "(N'Ekonomsko - trgovacka škola \"Knjaz Miloš\" - Gornji Milanovac', (select Id from Opstine where NazivOpstine = N'Gornji Milanovac'))," +
               "(N'Gimnazija \"Takovski ustanak\" - Gornji Milanovac', (select Id from Opstine where NazivOpstine = N'Gornji Milanovac'))," +
               "(N'Srednja škola - Grdelica', 97)," +
               "(N'Srednja škola \"Dragacevo\" - Dragačevo', 100)," +
               ...
               "(N'Srednja škola \"Dr Ðorde Natoševic\" - Inđija', (select Id from Opstine where NazivOpstine = N'Inđija'))," +
               "(N'Srednja stručna škola \"Borislav Mihajlovic Mihiz\" - Irig', (select Id from Opstine where NazivOpstine = N'Irig'))," +
               ...
               "(N'Ekonomsko - trgovinska škola \"Slavka Ðurdevic\" - Jagodina', (select Id from Opstine where NazivOpstine = N'Jagodina'))," +
               ...
               "(N'Poljoprivredno - tehnicki srednjoškolski centar \"Besedeš Jožef\" - Kanjiža', (select Id from Opstine where NazivOpstine = N'Kanjiža'))," +
               "(N'Gimnazija \"Dušan Vasiljev\" - Kikinda', (select Id from Opstine where NazivOpstine = N'Kikinda'))," +
               ...
               "(N'Muzička škola \"Miodrag Vasiljevic\" - Kosovska Mitrovica', (select Id from Opstine where NazivOpstine = N'Kosovska Mitrovica'))," +
               ...
               "(N'Muzička škola \"Dr Miloje Milojevic\" - Kragujevac', (select Id from Opstine where NazivOpstine = N'Kragujevac'))," +
               "(N'Politehnička škola - Kragujevac', (select Id from Opstine where NazivOpstine = N'Kragujevac'))," +
               "(N'Trgovinsko - ugostiteljska škola \"Toza Dragovic\" - Kragujevac', (select Id from Opstine where NazivOpstine = N'Kragujevac'))," +
               ...
               "(N'Prva kragujevačka gimnazija - Kragujevac', (select Id from Opstine where NazivOpstine = N'Kragujevac'))," +
               "(N'Druga kragujevačka gimnazija - Kragujevac', (select Id from Opstine where NazivOpstine = N'Kragujevac'))," +
               "(N'Medicinska škola \"Sestre Ninkovic\" - Kragujevac', (select Id from Opstine where NazivOpstine = N'Kragujevac'))," +
               ...
               "(N'Poljoprivredno - hemijska škola \"Dr Ðorde Radic\" - Kraljevo', (select Id from Opstine where NazivOpstine = N'Kraljevo'))," +
               ...
               "(N'Škola za osnovno i srednje obrazovanje \"Veselin Nikolic\" - Kruševac', (select Id from Opstine where NazivOpstine = N'Kruševac'))," +
               "(N'Hemijsko - tehnološka škola - Kruševac', (select Id from Opstine where NazivOpstine = N'Kruševac'))," +
               "(N'Muzička škola \"Stevan Hristic\" - Kruševac', (select Id from Opstine where NazivOpstine = N'Kruševac'))," +
               ...
               "(N'Gimnazija - Kuršumlija', (select Id from Opstine where NazivOpstine = N'Kuršumlija'))," +
               "(N'Tehnička škola “Ðuro Ðakovic\" - Kuršumlija', (select Id from Opstine where NazivOpstine = N'Kuršumlija'))," +
               ...
               "(N'Poljoprivredna škola Priština - Lešak', 96)," +
                ...
                "(N'Tehnička škola \"Rade Metalac\" - Leskovac', (select Id from Opstine where NazivOpstine = N'Leskovac'))," +
               "(N'Poljoprivredna škola - Leskovac', (select Id from Opstine where NazivOpstine = N'Leskovac'))," +
               "(N'Hemijsko - tehnološka škola \"Božidar Ðordevic Kukar\" - Leskovac', (select Id from Opstine where NazivOpstine = N'Leskovac'))," +
               ...
               "(N'Gimnazija \"Mile Arsenijevic Bandera\" - Majdanpek', (select Id from Opstine where NazivOpstine = N'Majdanpek'))," +
               ...
               "(N'Poljoprivredna škola \"Vršac\" - Vršac', (select id from Opstine where NazivOpstine = N'Vršac'))," +
               ...
               "(N'Gimnazija \"Branislav Petronijevic - Ub\" - Ub', (select id from Opstine where NazivOpstine = N'Ub'))," +
               "(N'Tehnička škola \"Ub\" - Ub', (select id from Opstine where NazivOpstine = N'Ub'))," +
               ...
               "(N'Šabačka gimnazija - Šabac', (select id from Opstine where NazivOpstine = N'Šabac'))," +
               ...
               "(N'Srednja škola \"Svilajnac\" - Svilajnac', (select id from Opstine where NazivOpstine = N'Svilajnac'))," +
               ...
               "(N'Palanacka gimnazija - Smederevska Palanka', (select id from Opstine where NazivOpstine = N'Smederevska Palanka'))," +
               ...
               "(N'Srednja tehnička škola \"Preševo\" - Preševo', (select id from Opstine where NazivOpstine = N'Preševo'))," +
               ...
               "(N'Požarevačka gimnazija - Požarevac', (select id from Opstine where NazivOpstine = N'Požarevac'))," +
