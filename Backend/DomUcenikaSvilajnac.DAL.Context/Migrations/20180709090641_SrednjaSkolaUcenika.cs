    ...
    public partial class SrednjaSkolaUcenika : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("insert into SrednjeSkole (NazivSrednjeSkole, OpstinaId) values " +
               ...
               "(N'Tehnička škola - \"Prota Stevan Dimitrijevic\"', (select Id from Opstine where NazivOpstine = N'Aleksinac'))," +
               "(N'Aleksinačka Gimanzija', (select Id from Opstine where NazivOpstine = N'Aleksinac'))," +
               ...
               "(N'Muzička škola \"Dr Vojislav Vuckovic\"', (select Id from Opstine where NazivOpstine = N'Stari grad'))," +
               ...
               "(N'Muzička škola \"Stankovic\"', (select Id from Opstine where NazivOpstine = N'Vračar'))," +
