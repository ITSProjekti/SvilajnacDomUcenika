...
namespace DomUcenikaSvilajnac.DAL.Context.Migrations
{
    public partial class DodavanjeTabeleOpstine : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            //migrationBuilder.Sql("delete from Opstine");

           // migrationBuilder.Sql("DBCC CHECKIDENT ('[Opstina]', RESEED, 0)");

            //migrationBuilder.Sql("delete from Mesta");

            //migrationBuilder.Sql("delete from Ucenici");

            //where NazivOpstine in (('Ada'), ('Aleksandrovac'), ('Aleksinac'), ('Alibunar'), ('Apatin'), ('Aranđelovac'), ('Arilje'), " +
            //    "('Babušnica'), ('Bajina Bašta'), ('Barajevo'), ('Batočina'), ('Bač'), ('Bačka Palanka'), ('Bačka Topola')," +
            //    "('Bački Petrovac'), ('Bela Palanka'), ('Bela Crkva'),('Beočin'), ('Bečej'),('Blace'),('Bogatić')," +
            //    "('Bojnik'), ('Boljevac'), ('Bor'), ('Bosilegrad'),('Brus'), ('Bujanovac'), ('Valjevo')," +
            //    " ('Varvarin'), ('Velika Plana'), ('Veliko Gradište'), ('Vitina'), ('Vladimirci'), ('Vladičin Han')," +
